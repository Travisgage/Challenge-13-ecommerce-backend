...
//GETS a single category by provided id value and associated Product data
...
//PUT to update a specific category
...
//DELETE to delete category by id
router.delete('/:id', async (req, res) => {
  try {
    ...
    //find products in the category to delete 
